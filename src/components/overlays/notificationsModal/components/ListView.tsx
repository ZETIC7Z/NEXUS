      ...
      <div className="flex justify-between items-center pb-4 mb-4 border-b border-white/5">
        ...
        <div className="flex items-center gap-2">
          {unreadCount > 0 && (
            ...
            >
              <Icon icon={Icons.X} className="text-[10px] group-hover:rotate-90 transition-transform" />
              Clear All
            </button>
          )}
          <button
            ...
            title="Refresh"
          >
            <Icon icon={Icons.RELOAD} className={loading ? "animate-spin" : ""} />
          </button>
          <button
            type="button"
      ...
      >
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <span className="text-sm font-medium text-type-secondary animate-pulse">Syncing notifications...</span>
          </div>
        )}
              ...
              <div className="relative w-20 h-28 flex-shrink-0 rounded-xl overflow-hidden bg-white/5 border border-white/10">
                {notification.posterUrl ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-white/10">
                    <Icon icon={notification.type === "movie" ? Icons.FILM : Icons.BELL} className="text-2xl" />
                  </div>
                )}
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider ${
                      getCategoryColor(notification.category) || "bg-white/10"
                    }`}>
                  ...
                  <div 
                    ...
                    dangerouslySetInnerHTML={{
                      __html: formatNotificationDescription(notification.description)
                    }}
                  />
                </div>
