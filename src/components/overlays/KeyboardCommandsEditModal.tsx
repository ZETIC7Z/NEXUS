...
export function KeyboardCommandsEditModal({
  ...
  // Fallback to defaults when persisted store value hasn't been migrated yet
  const resolvedShortcuts: KeyboardShortcuts =
    keyboardShortcuts ?? DEFAULT_KEYBOARD_SHORTCUTS;

  const [editingShortcuts, setEditingShortcuts] =
    useState<KeyboardShortcuts>(resolvedShortcuts);
