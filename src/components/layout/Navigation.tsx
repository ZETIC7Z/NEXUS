    ...
    >
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 w-64 bg-[#0d0d0d] border border-white/10 rounded-xl shadow-2xl shadow-black/50 z-50 animate-fadeIn p-2">
              ...
              {item.path === "/cuts" && (
                <span
                  ...
                  style={{
                    ...
                    color: "#fff",
                    boxShadow: "0 0 8px 2px rgba(220,38,38,0.7), 0 0 16px 4px rgba(220,38,38,0.4)",
                    animation: "cuts-badge-pulse 1.6s ease-in-out infinite",
          ...
          <style>{`
            @keyframes cuts-badge-pulse {
              0%, 100% { box-shadow: 0 0 8px 2px rgba(220,38,38,0.7), 0 0 16px 4px rgba(220,38,38,0.4); }
              50% { box-shadow: 0 0 16px 4px rgba(220,38,38,1), 0 0 32px 8px rgba(220,38,38,0.6); }
            }
          `}</style>
